...
class SeagateRepairTool(ctk.CTk):
    def __init__(self):
        ...
        self.log_info = ctk.CTkLabel(self.sidebar, text=f"Log File Created", font=ctk.CTkFont(size=10))
        self.log_info.pack(side="bottom", pady=10)
    ...
    # (Funções de conexão e log permanecem as mesmas das versões anteriores)
    def get_ports(self):
